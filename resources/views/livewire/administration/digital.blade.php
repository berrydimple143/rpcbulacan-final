<div id="digital-id">
    <div id="digitalID" style="border: 1px solid #aaa; margin-top: 5%; margin-left: auto; margin-right: auto; margin-bottom: 0; width: 765px; height: 485px; background-image: url(https://rpcbulacan.org/images/leni.png)">
      ...
      <div style="font-size: 10px; position: relative; top: 400px; left: 215px;">
        <a href="{{ route('registrants') }}" class="btn btn-lg btn-primary">{{ strtoupper('<< BACK TO REGISTRANTS') }}</a>
      </div>
    </div>
<div>